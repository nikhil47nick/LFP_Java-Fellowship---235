...
public class TicTacToe {
   ...
   TicTacToe(){
    ...
    public void computerPlayer(char ch){
            ...
            if(board[2]==board[3] || board[4] ==board[7] || board[5]==board[9] && board[1] == ' '){
                    board[1]=ch;
            }else if(board[1]==board[3] || board[5] ==board[8] && board[2] == ' '){
                    board[2]=ch;
            }else if(board[1]==board[2] || board[6] ==board[9] || board[5]==board[7] && board[3] == ' '){
                    board[3]=ch;
            }else if(board[1]==board[7] || board[5] ==board[6] && board[4] == ' '){
                    board[4] = ch;
            }else if(board[1]==board[9] || board[4] ==board[6] || board[2]==board[8] || board[3]==board[7] && board[5] == ' '){
                        board[5]=ch;
            }else if(board[3]==board[9] || board[4] ==board[5] && board[6] == ' '){
                        board[6]=ch;
            }else if(board[1]==board[4] || board[8] ==board[9] || board[5]==board[3]&& board[7] == ' '){
                        board[7]=ch;
            }else if(board[2]==board[5] || board[7] ==board[9] && board[8] == ' '){
                        board[8]=ch;
            }else if(board[3]==board[6] || board[7] ==board[8] || board[1]==board[5] && board[9] == ' '){
                        board[9]=ch;
            }else if (board[1] == ' '){
                    board[1]=ch;
            }else if (board[3] == ' '){
